      ...
      <section className="text-gray-700 body-font bg-gray-300">
        <div className="container px-5 py-12 mt-8 mb-16 mx-auto">
          ...
          <div className="flex w-full justify-center">
            <input className="border-0 bg-white rounded mr-4 border border-gray-400 focus:outline-none focus:border-pink-500 text-base px-4 lg:w-full xl:w-1/2 w-2/4 md:w-full" placeholder="キャプチャしたいページのURL" type="url" />
